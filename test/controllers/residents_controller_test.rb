...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post residents_url, params: { resident: { author_id: @resident.author_id, date_of_birth: @resident.date_of_birth, first_name: @resident.first_name, last_name: @resident.last_name, room: @resident.room } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { author_id: @resident.author_id, date_of_birth: @resident.date_of_birth, first_name: @resident.first_name, last_name: @resident.last_name, room: @resident.room } }
